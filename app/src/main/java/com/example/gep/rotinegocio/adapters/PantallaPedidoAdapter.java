...
public class PantallaPedidoAdapter extends RecyclerView.Adapter<PantallaPedidoAdapter.MyViewHolder> {

    private Pedido [] pedidos;/*PROVISORIO*/

    public PantallaPedidoAdapter(Pedido [] pedidos){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_pantalla_pedidos, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.nombreCliente.setText(pedidos[position].getCliente().getNombreCliente().toUpperCase());
